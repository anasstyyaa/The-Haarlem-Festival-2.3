...
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="d-flex align-items-center mb-4">
            ...
            <h2 class="mb-0">Add New Dance Event</h2>
        </div>

        <div class="card shadow-sm border-0">
            <div class="card-header bg-white py-3">
                <h5 class="mb-0">Dance Event Details</h5>
            </div>

            <div class="card-body p-4">
                <form action="/admin/dance/events/create" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="venue_id" class="form-control" required>
                            ...
                            <option value="1">Lichtfabriek</option>
                            <option value="2">Slachthuis</option>
                            <option value="3">Jopenkerk</option>
                            <option value="4">XO the Club</option>
                        </select>
                    </div>
