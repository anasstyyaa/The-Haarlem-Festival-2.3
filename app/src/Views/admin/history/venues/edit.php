...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2><i class="bi bi-pencil-square me-2"></i>Edit History Venue</h2>
...
<div class="card shadow-sm border-0">
    <div class="card-body">
        <form method="POST" action="/admin/history/venues/edit">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="details" name="details" rows="4"><?= htmlspecialchars($venue->getDetails() ?? '') ?></textarea>
            </div>
